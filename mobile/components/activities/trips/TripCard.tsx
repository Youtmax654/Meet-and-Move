        ...
        >
            <YStack position="relative" height={160}>
                ...
                >
                    ...
                    <Text fontSize={10} fontWeight="800" color="#4338CA" letterSpacing={0.5}>
                        {trip.tag}
                    </Text>
                </XStack>
            </YStack>
            ...
            <YStack paddingHorizontal={16} paddingVertical={20} gap={12}>
                <XStack justifyContent="space-between" alignItems="flex-start">
                    <Text fontSize={11} color="#B4332A" fontWeight="800" letterSpacing={1} textTransform="uppercase">
                        {trip.dateRange}
                    </Text>
                    <YStack alignItems="flex-end">
                        <Text fontSize={9} color="#8A8F98" fontWeight="700" letterSpacing={0.8} textTransform="uppercase">
                            {trip.locationArea}
                        </Text>
                ...
                <XStack justifyContent="space-between" alignItems="center" marginTop={16}>
                    <AvatarGroup avatars={trip.avatars} extraCount={trip.extraAvatarsCount} />
